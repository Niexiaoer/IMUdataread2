...
typedef struct _mip_EF_data
{
	struct _mip_filter_status mip_filter_status;
	struct _mip_filter_timestamp mip_filter_timestamp;
	struct _mip_filter_attitude_euler_angles mip_filter_attitude_euler_angles;
	struct _mip_filter_euler_attitude_uncertainty mip_filter_euler_attitude_uncertainty;
	struct _mip_filter_linear_acceleration mip_filter_linear_acceleration;
	struct _mip_filter_compensated_acceleration mip_filter_compensated_acceleration;
	struct _mip_filter_compensated_angular_rate mip_filter_compensated_angular_rate;
	struct _mip_filter_gyro_bias mip_filter_gyro_bias;
	struct _mip_filter_gyro_bias_uncertainty mip_filter_gyro_bias_uncertainty;
	struct _mip_filter_pressure_altitude_mip_field mip_filter_pressure_altitude_mip_field;
}mip_EF_data;
